...
def update_picture_urls(updated_data, s3_BUCKET_NAME, picture_name_self, picture_name_id):
    """Update picture URLs."""

    logger.debug("Updating picture URLs for %s and %s", picture_name_self, picture_name_id)

    profile_picture_url = generate_presigned_url(s3_BUCKET_NAME, picture_name_self)
    id_proof_picture_url = generate_presigned_url(s3_BUCKET_NAME, picture_name_id)
